"""
Django settings for round_silence_43142 project.
...
ROOT_URLCONF = 'round_silence_43142.urls'
...
WSGI_APPLICATION = 'round_silence_43142.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_silence_43142 API",
    "DESCRIPTION": "API documentation for round_silence_43142 App",
    "VERSION": "v1",
}
